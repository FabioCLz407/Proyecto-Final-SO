...
# Crear un conjunto de datos ficticios
data_dict = {
    'track_name': [f'Song {i}' for i in range(1, 21)],
    'streams': np.random.randint(5000, 50000, size=20),
    'danceability_%': np.random.uniform(40, 100, size=20),
    'in_spotify_playlists': np.random.randint(1, 50, size=20),
    'energy_%': np.random.uniform(30, 90, size=20),
    'valence_%': np.random.uniform(20, 80, size=20)
}
...
num_rows = st.sidebar.slider('Número de filas para mostrar', min_value=10, max_value=20, value=20)
